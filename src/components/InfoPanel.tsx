  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div className="relative">
        ...
        <p className="relative text-xs font-mono text-violet-400 mb-2 uppercase tracking-[0.2em] font-medium">
          genesis block
        </p>
        <h2 className="relative text-4xl font-bold text-white tracking-tight drop-shadow-lg">
          {node.label}
        </h2>
        <p className="relative text-violet-300 font-medium mt-2 text-lg drop-shadow-md">
          {content?.subtitle}
        </p>
      </div>
      ...
      <div className="flex flex-col gap-3 pt-2">
        {content?.socialLinks?.github && (
          ...
          >
            <div className="flex items-center gap-3">
              <Github
                size={18}
                className="text-violet-400 group-hover:scale-110 transition-transform"
              />
        ...
        {content?.socialLinks?.email && (
          ...
          >
            ...
            <ExternalLink
              size={14}
              className="text-slate-600 group-hover:text-pink-400 transition-colors"
            />
          </a>
        )}
      </div>
    ...
    <div className="space-y-6 animate-in slide-in-from-right-4 duration-500">
      ...
      >
        ...
        <span style={{ color: catColor }}>
          <CategoryIcon category={s.category} size={28} />
        </span>
      </div>
      ...
      {s.level && (
        <div className="p-5 rounded-xl bg-black/20 border border-white/5">
          ...
          <p className="text-lg font-medium capitalize text-white mb-2">
            {s.level}
          </p>
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="p-5 rounded-xl bg-white/[0.03] border border-white/5 relative overflow-hidden">
        ...
        <p className="text-slate-300 text-sm leading-relaxed font-light pl-2">
          {e.description}
        </p>
      </div>
    </div>
...
function ContactContent({ node }: { node: PortfolioNode }) {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <div>
        <p className="text-xs font-mono text-pink-400 uppercase tracking-widest mb-2">
          Network Hub
        </p>
      ...
      >
        ...
        <div className="text-center relative z-10">
          <p className="font-bold text-lg text-white mb-1 group-hover:text-pink-100 transition-colors">
            {c.label}
          </p>
          <p className="text-sm text-pink-300/80 font-mono tracking-wide">
            {c.value}
          </p>
        </div>
...
function MainNodeContent({ node }: { node: PortfolioNode }) {
  ...
  return (
    <div className="space-y-6 pt-4 animate-in fade-in duration-500">
      ...
      <div
        className="mt-8 p-4 rounded-xl border border-dashed text-center"
        style={{ borderColor: nodeColor + "40", background: nodeColor + "05" }}
      >
        <p
...
export default function InfoPanel({ node, onClose }: InfoPanelProps) {
  const renderContent = () => {
    ...
    switch (node.type) {
      case "genesis":
        return <GenesisContent node={node} />;
      case "project":
        return <ProjectContent node={node} />;
      case "skill":
        return <SkillContent node={node} />;
      case "experience-item":
        return <ExperienceContent node={node} />;
      case "contact-item":
        return <ContactContent node={node} />;
      default:
        return <MainNodeContent node={node} />;
    }
  };
        ...
        <>
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(145deg, rgba(12, 12, 28, 0.85), rgba(5, 5, 15, 0.95))",
            ...
            >
              ...
              <div
                ...
                style={{
                  background: `radial-gradient(circle, ${nodeColor}, transparent 70%)`,
              ...
              <div className="h-1 w-full relative">
                <div
                  ...
                  style={{
                    background: `linear-gradient(90deg, ${nodeColor}22, ${nodeColor}, ${nodeColor}22)`,
                  }}
                />
                <div
